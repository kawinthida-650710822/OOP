...
* **Java**: ใช้คำว่า `extends` เพื่อให้คลาสลูกสามารถสืบทอดคุณสมบัติและพฤติกรรมจากคลาสพ่อได้
* **C++**: ใช้เครื่องหมาย `:` เพื่อระบุประเภทการสืบทอด&#x20;
* **Python**: ระบุชื่อคลาสพ่อในวงเล็บหลังชื่อคลาสลูกเพื่อทำการสืบทอด
